        ...
        <section ref={heroRef} className="pt-32 pb-6 px-6 md:pb-10">
          <div className="max-w-6xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-br from-[#1e1e2f] to-[#2c2c3e] rounded-full border border-gray-400 backdrop-blur-sm mb-6">
              ...
              <span className="text-sm font-medium text-green-300 uppercase tracking-wider">About Society Sync</span>
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-normal font-nunito">
              Society Sync is a centralized platform that helps colleges run societies in a fair, transparent, and structured way – from recruitment and interviews to events, panels, and verified digital certificates.
            </p> 
          </div>
        </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-[#1e1e2f] to-[#2c2c3e] backdrop-blur-sm border-2 border-gray-300 border-opacity-20 rounded-3xl p-6 md:px-6 py-10 transition-all duration-300 hover:scale-[1.03] hover:shadow-cyan-500/20 group">
              ...
              <p className="text-base md:text-lg text-gray-300 leading-relaxed text-center max-w-xl mx-auto font-nunito font-normal">
                Society Sync envisions a future where every college society operates on a transparent, accountable foundation. We aim to give institutes a reliable system of record while preserving the creativity, culture, and mentorship that student communities naturally build.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={missionRef} className="py-8 px-6">
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-[#1e1e2f] to-[#2c2c3e] backdrop-blur-sm border-2 border-gray-300 border-opacity-20 rounded-3xl p-6 md:px-6 py-10 transition-all duration-300 hover:scale-[1.03] hover:shadow-cyan-500/20 group">
              ...
              <p className="text-base md:text-lg text-gray-300 leading-relaxed text-center max-w-xl mx-auto font-nunito font-normal">
                Our mission is to centralize society operations into one platform that can start with a single college and scale to multiple campuses. Society Sync helps manage recruitment, interviews, events, and certificates while enforcing one-official-society-per-student and giving faculty and admins clear oversight.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="text-center mb-16">
              ...
              <div className="bg-gradient-to-br from-[#1e1e2f] to-[#2c2c3e] backdrop-blur-sm border-2 border-gray-300 border-opacity-20 rounded-3xl p-6 max-w-4xl mx-auto md:p-12 transition-all duration-300 hover:scale-[1.03] hover:shadow-cyan-500/20 group">
                <p className="text-base md:text-2xl text-gray-300 leading-relaxed font-nunito font-normal">
                  Unlike a single-society website, Society Sync is built as an institution-ready system – enforcing fair recruitment, verified memberships, role-based dashboards, and scalable data models that work across departments, colleges, and universities.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 benefits-grid">
              <div className="bg-gradient-to-br from-[#1e1e2f] to-[#2c2c3e] backdrop-blur-sm border-2 border-gray-300 border-opacity-20 rounded-2xl p-8 transition-all duration-300 hover:scale-[1.03] hover:shadow-cyan-500/20 group flex flex-col items-center justify-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4 font-montserrat">Fair Recruitment Pipelines</h3>
                <p className="text-center text-gray-300 leading-relaxed">
                  Run structured recruitment and interview flows with clear status tracking so students, society heads, and faculty all see what is happening.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1e1e2f] to-[#2c2c3e] backdrop-blur-sm border-2 border-gray-300 border-opacity-20 rounded-2xl p-8 transition-all duration-300 hover:scale-[1.03] hover:shadow-cyan-500/20 group flex flex-col items-center justify-center">
                ...
                <h3 className="text-center text-xl font-bold text-white mb-4 font-montserrat">Verified Membership & Certificates</h3>
                <p className="text-center text-gray-300 leading-relaxed font-nunito">
                  Ensure each student is officially part of only one society, while issuing tamper‑resistant digital certificates that faculty can validate.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1e1e2f] to-[#2c2c3e] backdrop-blur-sm border-2 border-gray-300 border-opacity-20 rounded-2xl p-8 transition-all duration-300 hover:scale-[1.03] hover:shadow-cyan-500/20 group flex flex-col items-center justify-center">
                ...
                <h3 className="text-center text-xl font-bold text-white mb-4 font-montserrat">Role-Based Dashboards</h3>
                <p className="text-center text-gray-300 leading-relaxed font-nunito">
                  Give students, society heads, faculty, and admins separate dashboards tailored to their responsibilities and approvals.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1e1e2f] to-[#2c2c3e] backdrop-blur-sm border-2 border-gray-300 border-opacity-20 rounded-2xl p-8 transition-all duration-300 hover:scale-[1.03] hover:shadow-cyan-500/20 group flex flex-col items-center justify-center">
                ...
                <h3 className="text-center text-xl font-bold text-white mb-4 font-montserrat">Scalable Multi‑Campus Ready</h3>
                <p className="text-center text-gray-300 leading-relaxed font-nunito">
                  Start with a single society or college and grow to multi‑college or multi‑university deployments without losing historical data.
                </p>
              </div>
            </div>
          </div>
